        ...
        <div className="flex items-center justify-between gap-3 sm:gap-6">
          <div className="flex items-center space-x-3 shrink-0">
            <a href="#" className="group flex items-center gap-2">
              <div className="relative w-10 h-10 sm:w-11 sm:h-11 bg-gradient-to-tr from-red-600 to-red-500 rounded-2xl flex items-center justify-center shadow-lg shadow-red-500/30 group-hover:scale-105 transition-transform duration-300 shrink-0">
                <Flame className="w-6 h-6 text-white fill-white/20 animate-pulse shrink-0" />
            ...
            >
              <MapPin className="w-4 h-4 text-red-500 group-hover:scale-110 transition-transform shrink-0" />
              <span>{district?.name || 'Заволжье'}</span>
              <span className="text-[10px] bg-red-500/20 text-red-400 border border-red-500/30 px-2 py-0.5 rounded-full font-medium shrink-0">
          ...
          <button
            onClick={openDistrictModal}
            className="lg:hidden flex items-center space-x-1.5 bg-slate-800/90 border border-slate-700 px-2.5 py-1.5 rounded-xl text-xs font-semibold text-slate-200 shrink-0"
          >
          ...
          <a
            href="tel:+79308184040"
            className="sm:hidden p-2 bg-slate-800 border border-slate-700 rounded-xl text-red-400 hover:bg-slate-700 shrink-0"
          ...
          <button
            ...
            className="relative hidden sm:flex items-center space-x-3 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-600 text-white font-bold px-5 py-2.5 rounded-2xl shadow-lg shadow-red-500/25 transition-all duration-200 active:scale-95 group shrink-0"
          >
            <div className="relative shrink-0">
              <ShoppingBag className="w-5 h-5 group-hover:rotate-12 transition-transform shrink-0" />
              {totalItemsCount > 0 && (
